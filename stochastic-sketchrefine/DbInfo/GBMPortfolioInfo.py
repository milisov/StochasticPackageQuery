...
class GBMPortfolioInfo(DbInfo):
    ...
    def get_variable_generator_function(
        ...
        if attribute == 'gain':
            return GBMGainScenarioGenerator
    ...
    def is_deterministic_attribute(
        ...
        return (attribute in \
            GBMPortfolioInfo.get_deterministic_attributes())
    ...
    def get_diameter_threshold(
        ...
        if attribute == 'gain':
            return Hyperparameters.DIAMETER_THRESHOLD_GBM_GAIN
        if attribute == 'price':
            return Hyperparameters.DIAMETER_THRESHOLD_GBM_PRICE
